...
func (*WidgetList) Descriptor() ([]byte, []int) {
	return file_csv_proto_rawDescGZIP(), []int{3}
}
...
func (*WidgetResponse) Descriptor() ([]byte, []int) {
	return file_csv_proto_rawDescGZIP(), []int{4}
}
...
const file_csv_proto_rawDesc = "" +
	"\n" +
	"\tcsv.proto\x12\fcdaysdemo.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x19google/api/httpbody.proto\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\"+\n" +
...
var file_csv_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
